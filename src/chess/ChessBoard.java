...
public class ChessBoard {
        ...
        if (checkPos(startLine) && checkPos(startColumn)) {
            ...
            if (board[startLine][startColumn].canMoveToPosition(this, startLine, startColumn, endLine, endColumn)) {
                if ( (board[startLine][startColumn] instanceof Rook) ||
                     (board[startLine][startColumn] instanceof King) ){
    ...
    public boolean isValidPath(String color, int line, int column, int toLine, int toColumn)
    {
        int dLine = Math.abs(line-toLine);
        int dColumn = Math.abs(column-toColumn);
        int signLine = dLine==0 ? 0 : (toLine > line ? 1 : -1);
        int signColumn = dColumn==0 ? 0 : (toColumn > column ? 1 : -1);
        for (int s = 1; s < dLine; s += 1) {
            int i = line + s*signLine;
            int j = column + s*signColumn;
            if (board[i][j] != null) {
                return false;
            }
        }
        return (board[toLine][toColumn] == null) ||
                ((color!=null) && !board[toLine][toColumn].getColor().equals(color));
    }

    public boolean castling0() {
        if (nowPlayer.equals("White")) {
            if (board[0][0] == null || board[0][4] == null) return false;
            if (board[0][0].getSymbol().equals("R") && board[0][4].getSymbol().equals("K") && // check that chess.King and chess.Rook
                ...
                if (board[0][0].getColor().equals("White") && board[0][4].getColor().equals("White") &&
                    ...
                    board[0][4] = null;
                    board[0][2] = new King("White");   // move chess.King
                    board[0][2].check = false;
                    board[0][0] = null;
                    board[0][3] = new Rook("White");   // move chess.Rook
            ...
            if (board[7][0].getSymbol().equals("R") && board[7][4].getSymbol().equals("K") && // check that chess.King and chess.Rook
                ...
                if (board[7][0].getColor().equals("Black") && board[7][4].getColor().equals("Black") &&
                    ...
                    board[7][4] = null;
                    board[7][2] = new King("Black");   // move chess.King
                    board[7][2].check = false;
                    board[7][0] = null;
                    board[7][3] = new Rook("Black");   // move chess.Rook
    ...
    public boolean castling7() {
        if (nowPlayer.equals("White")) {
            ...
            if (board[0][7].getSymbol().equals("R") && board[0][4].getSymbol().equals("K") && // check that chess.King and chess.Rook
                ...
                if (board[0][7].getColor().equals("White") && board[0][4].getColor().equals("White") &&
                    ...
                    board[0][4] = null;
                    board[0][6] = new King("White");   // move chess.King
                    board[0][6].check = false;
                    board[0][7] = null;
                    board[0][5] = new Rook("White");   // move chess.Rook
            ...
            if (board[7][7].getSymbol().equals("R") && board[7][4].getSymbol().equals("K") && // check that chess.King and chess.Rook
                ...
                if (board[7][7].getColor().equals("Black") && board[7][4].getColor().equals("Black") &&
                    ...
                    board[7][4] = null;
                    board[7][6] = new King("Black");   // move chess.King
                    board[7][6].check = false;
                    board[7][7] = null;
                    board[7][5] = new Rook("Black");   // move chess.Rook
